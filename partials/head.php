...
<head>
    ...
    <!-- Condition pour un titre dynamique -->
    <?php if(isset($title) && !empty($title)) : ?>
        <title><?= $title ?> - Liste de films</title>
    <?php else : ?>
        <title>Liste de films</title>
    <?php endif ?>

    <!-- Condition pour une description dynamique -->
    ...
    <meta name="author" content="dwwm20">
    <meta name="publisher" content="dwwm20">
